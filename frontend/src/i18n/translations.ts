...
export const translations: Record<UILang, Record<string, string>> = {
  en: {
    ...
    "insightsSection.subtext": "Subtext (optional)",
    "insightsSection.subtextEn": "Subtext (optional, EN)",
    "insightsSection.subtextDe": "Subtext (optional, DE)",
    "insightsSection.shortDescription": "Description",
    "insightsSection.shortDescriptionEn": "Description (EN)",
    "insightsSection.shortDescriptionDe": "Description (DE)",
    ...
    "insightsSection.viewMore": "View more",
  ...
  de: {
    ...
    "insightsSection.nameEn": "Name (EN)",
    "insightsSection.nameDe": "Name (DE)",
    "insightsSection.subtext": "Untertitel (optional)",
    "insightsSection.subtextEn": "Untertitel (optional, EN)",
    "insightsSection.subtextDe": "Untertitel (optional, DE)",
    "insightsSection.shortDescription": "Beschreibung",
    "insightsSection.shortDescriptionEn": "Beschreibung (EN)",
    "insightsSection.shortDescriptionDe": "Beschreibung (DE)",
    ...
    "insightsSection.viewMore": "Mehr anzeigen",
